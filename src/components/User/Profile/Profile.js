...
import { followUserAction, unfollowUserAction, userProfileAction } from "../../../redux/slices/users/userSlices";
...
// console.log(profile?.viewedBy?.length)
    ...
    <>
      <div className="min-h-screen  bg-green-400 flex justify-center items-center ">
        {profileLoading ? (
          ...
          <div className="h-screen w-fit flex overflow-hidden bg-white">
                      ...
                      <div className="w-full md:w-2/3 px-4 mb-4 md:mb-0">
                        ...
                        {profile?.posts?.length <= 0 ? (
                          ...
                          profile?.posts?.map(post => (
                            <div className="flex flex-wrap  -mx-3 mt-3 mb-4  lg:mb-6">
