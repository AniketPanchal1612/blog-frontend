...
export default function PostsList() {
  ...
  // console.log(newDes)
  // const updatedContent = newDes?.replace(/color: rgb\(5, 5, 5\);/g, 'color: #ffffff;');
  // console.log(postLists)
  // console.log(newDes)
  // console.log(post)
  return (
    <>
      <section>
        <div className="py-20 bg-gray-600 min-h-screen radius-for-skewed">
          <div className="container mx-auto px-4">
            ...
            <div className="flex flex-wrap -mx-3">
              <div className="mb-8 lg:mb-0 w-full lg:w-1/4 px-3">
                <div className="py-4 px-6 bg-gray-800 shadow rounded">
              ...
              <div class="w-full lg:w-3/4 px-3">
                ...
                {appErr || serverErr ? (
                  ...
                  postLists?.map(post => (
                    <div
                      key={post.id}
                      className="flex flex-wrap bg-gray-700 -mx-3  lg:mb-6"
                    >
                      ...
                      <div className="w-full lg:w-3/4 px-3">
                        ...
                        <p className="text-gray-300">
                          ...
                          {ReactHtmlParser(post?.description?.replace(/color: rgb\(5, 5, 5\);/g, 'color: #ffffff;').slice(0,400))}
